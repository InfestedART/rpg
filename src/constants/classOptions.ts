...
export const CLASS_STATS = {
  soldier: { baseDmg: 3, baseHp: 23, moveSpeed: 4, attackCount: 1, initiative: 3}, // total: 14
  wizard: { baseDmg: 6, baseHp: 15, moveSpeed: 3, attackCount: 1, initiative: 6 }, // total: 13
  ranger: { baseDmg: 4, baseHp: 18, moveSpeed: 5, attackCount: 1, initiative: 4}, // total: 14
  warrior: { baseDmg: 6, baseHp: 20, moveSpeed: 4, attackCount: 1, initiative: 3}, // total: 15
  bandit: { baseDmg: 4, baseHp: 18, moveSpeed: 5, attackCount: 1, initiative: 5}, // total: 15
}
...
export const ALL_STATS = { ...CLASS_STATS, ...ENEMY_STATS}