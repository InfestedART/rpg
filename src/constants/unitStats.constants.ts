...
export const ENEMY_STATS: Record<EnemyClassType, UnitStatsT> = {
  brigand: { baseDmg: 3, dmgDice: 4, baseHp: 18, moveSpeed: 4, attackCount: 1, critChance: 0.1, initiative: 3 },
  skeleton: { baseDmg: 2, dmgDice: 3, baseHp: 10, moveSpeed: 3, attackCount: 1, critChance: 0.15, initiative: 2 }, 
  rat: { baseDmg: 1, dmgDice: 2, baseHp: 6, moveSpeed: 3, attackCount: 1, critChance: 0.1, initiative: 2}, 
