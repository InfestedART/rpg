...
export const ENEMY_STATS: Record<EnemyClassType, UnitStatsT> = {
  ...
  skeleton: { baseDmg: 2, dmgDice: 3, baseHp: 10, moveSpeed: 3, attackCount: 1, critChance: 0.15, initiative: 2, range: 1, icon: 'skeleton1' }, 
  rat: { baseDmg: 1, dmgDice: 2, baseHp: 6, moveSpeed: 3, attackCount: 1, critChance: 0.1, initiative: 2, range: 1, icon: 'rat' }, 
